...
``` {r , echo = FALSE}
setwd("/Users/juanreyes/Documents/georgetown/datascience/670_final_project")
```
...
<!-- # model_cps2018 <- weighted_cps_2018 %>% -->
<!-- #   select (-poverty , -hhincome) %>% -->
<!-- #   filter(!is.na(offpov))  -->
<!-- #  -->
<!-- # #Splitting 2018 data into a training and testing set -->
<!-- # set.seed(12112022) -->
<!-- #  -->
<!-- # poverty_modeling_split <- initial_split(model_cps2018) -->
<!-- # poverty_modeling_train <- training(x = poverty_modeling_split) -->
<!-- # poverty_modeling_test  <- testing(x = poverty_modeling_split) -->
<!-- # ``` -->
<!-- #  -->
<!-- # ``` {r} -->
<!-- # #1. Setting up v-fold cross-validation with 4 folds -->
<!-- # folds <- vfold_cv(poverty_modeling_train, v = 4) -->
<!-- #  -->
<!-- # #2. Creating a recipe object  -->
<!-- # poverty_rec <- -->
<!-- #   recipe(offpov ~., data = poverty_modeling_train) %>% -->
...
<!-- #  -->
<!-- # ``` -->
<!-- # #5. Calculating MAE and RMSE -->
<!-- # forest_rs %>% -->
<!-- #   collect_metrics() -->
<!-- # #The mean MAE is , and the mean RMSE is  -->
<!-- # forest_rs %>% -->
<!-- #   show_best() -->
<!-- # forest_rs %>% -->
<!-- #   select_best() -->
